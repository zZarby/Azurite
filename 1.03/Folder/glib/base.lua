...
function shared.azuritebaselua._706e616d65() local name = tostring(math.random(1234567890)) return name end
function shared.azuritebaselua._746963()
	local sound = Instance.new("Sound", game.Workspace)
	sound.SoundId = "rbxassetid://876939830"
	sound:Play()
end
function shared.azuritebaselua:Notification(t)
...
function shared.azuritebaselua:Copy(t)
	local clip = setclipboard or toclipboard or set_clipboard or (Clipboard and Clipboard.set)
	if clip then
		clip(tostring(t))
		shared.azuritebaselua:Notification("Copied to clipboard")
	else
		shared.azuritebaselua:Notification("Your Exploit Doesn't Support Clipboard")
...
function shared.azuritebaselua:Main()
	...
	mn.ScreenGui.Name = shared.azuritebaselua._706e616d65()
	mn.ScreenGui.ResetOnSpawn = false

	mn.Base.Name = shared.azuritebaselua._706e616d65()
	...
	mn.Scroll.Name = shared.azuritebaselua._706e616d65()
	...
	for i,v in pairs(mn.Icon:GetChildren()) do
		...
		if v.Name == "Discord" then 
            func = function()
                shared.azuritebaselua:Copy(shared.azuritebaselua.__DIsCoRD)
            end
		end
		...
		if v.Name == "Executor" then
			func = function()
                shared.azuritebaselua:Copy(shared.azuritebaselua.__ExEcuT0r)
            end
		end
