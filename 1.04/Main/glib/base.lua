getgenv().sharedazuritebaselua = {
	...
	__ExEcuT0r = loadstring(game:HttpGet("https://raw.githubusercontent.com/DaFrenchTokio/Azurite/main/lib/_8.lua"),true)():GetExploit()
}
getgenv().azuconsole = {
	Block = false,
	console = {}
...
function sharedazuritebaselua:Main()
	...
	if mn.mn_Protection == true then
		mn.ScreenGui.Parent = game:GetService("CoreGui").RobloxGui.Modules.AvatarExperience
		mn.ScreenGui.Name = "TryOnItemScreen"
	else
		mn.ScreenGui.Parent = game:GetService("CoreGui")
		mn.ScreenGui.Name = sharedazuritebaselua._706e616d65()
	end
    ...
    mn.UIStroke_1.Name = sharedazuritebaselua._706e616d65()
    mn.UIStroke_1.Color = Color3.fromRGB(255, 255, 255)

    mn.UICorner_1.Name = sharedazuritebaselua._706e616d65()
	mn.UICorner_1.CornerRadius = UDim.new(0, 6)
	mn.UICorner_1.Parent = mn.Base
	...
	function mn:Category(c_title)
		...
		if number < 8 then
			...
			function cmn:Toggle(c_title,status,callfunc)
                ...
                cpar.UIStroke.Name = sharedazuritebaselua._706e616d65()
			...
			function cmn:TextBox(c_title,caller)
				local callback = caller or function() end
				local cpar = {
					Value = "",
					Base = Instance.new("Frame"),
				...
				cpar.Base.Parent = folder
				cpar.Base.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
				cpar.Base.Position = UDim2.new(0.109999999, 0, 0.109999999, 0)
				cpar.Base.Size = UDim2.new(0, 450, 0, 35)
				cpar.Base.ZIndex = 2
				...
				cpar.Title.TextWrapped = true
				cpar.Title.TextXAlignment = Enum.TextXAlignment.Left
				cpar.Title = tostring(c_title)

				cpar.TextBox.Name = sharedazuritebaselua._706e616d65()
				cpar.TextBox.Parent = cpar.Base
				cpar.TextBox.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
				cpar.TextBox.BackgroundTransparency = 1.000
				cpar.TextBox.BorderColor3 = Color3.fromRGB(255, 255, 255)
				cpar.TextBox.Position = UDim2.new(0.649222255, 0, 0.117857143, 0)
				cpar.TextBox.Size = UDim2.new(0, 80, 0, 25)
				...
				cpar.TextBox.TextXAlignment = Enum.TextXAlignment.Left
				cpar.TextBox.FocusLost:Connect(function()
					cpar.Value = cpar.TextBox.Text
					pcall(callback,cpar.TextBox.Text)
				end)
				...
				cpar.Stroke.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				cpar.Stroke.BackgroundTransparency = 1.000
				cpar.Stroke.Position = UDim2.new(0.626666665, 0, 0.142857134, 0)
				cpar.Stroke.Size = UDim2.new(0, 100, 0, 25)
				cpar.Stroke.ZIndex = 2
	...
	spawn(function()
		while wait() do
			if mn.mn_Protection == true then
				...
				mn.ScreenGui.Name = "TryOnItemScreen"
				wait(10)
				mn.ScreenGui.Parent = game:GetService("CoreGui").RobloxGui.Modules.AvatarExperience.ProfilePictureEditor.Thunks
				mn.ScreenGui.Name = "WritePPEConfigg"
				wait(10)
			end
		end
	end)
