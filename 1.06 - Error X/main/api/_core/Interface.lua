...
function __UI__:Main()
	...
	mn.Discord.Name = __UI__._706e616d65()
	...
	game:GetService("CoreGui").RobloxGui.SettingsShield.SettingsShield:GetPropertyChangedSignal("Visible"):Connect(function()
		if game:GetService("CoreGui").RobloxGui.SettingsShield.SettingsShield.Visible == true and game:GetService("CoreGui").RobloxGui.SettingsShield.SettingsShield.Position == UDim2.new(0, 0, 0, 0) then
